...
## Companion Specification — Draft v0.2.1

**Status:** Draft v0.2.1 — supersedes v0.2. Review round complete; ratification record in §13 (append-only as of this cut).
...
---
*Draft v0.2.1 — correction cut 2026-08-23 against ccip-router#3/#4 (branch), ERCs#1826, recompute-kit#17. Every resolution above cites the message, commit, or ratification that produced it; §13 is append-only from this cut forward.*
