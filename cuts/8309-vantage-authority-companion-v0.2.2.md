...
## Companion Specification — Draft v0.2.2

**Status:** Draft v0.2.2 — supersedes v0.2.1. Review round complete; ratification record in §13 (append-only).
...
---
*Draft v0.2.2 — correction cut 2026-08-23 against ccip-router#3/#4 (branch), ERCs#1826, recompute-kit#17 (branch). Every resolution above cites the message, commit, or ratification that produced it; §13 is append-only.*
